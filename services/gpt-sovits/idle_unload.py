...
Twin file: the class body is kept identical to
services/vocal-separation/idle_unload.py and services/diarisation/idle_unload.py
— the services are independent and deliberately don't share a module, so apply
any fix to all three files.
