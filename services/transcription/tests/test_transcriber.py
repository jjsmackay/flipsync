...
class TestGetWavDuration:
    ...
    def test_nonexistent_file_returns_large_value(self, tmp_path):
        duration = get_wav_duration(str(tmp_path / "no_such_file.wav"))
        # Should return 999.0 fallback rather than raising
