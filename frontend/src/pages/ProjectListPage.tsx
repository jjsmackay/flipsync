  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-2 mb-3">
        <h3 className="text-sm font-semibold text-gray-900 truncate flex-1" title={project.name}>
          {project.name}
        </h3>
      ...
      <div className="grid grid-cols-3 gap-2 mb-4">
        ...
        <div className="text-center">
          <div className="text-lg font-semibold text-gray-600">{project.stats.pending_count}</div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-gray-900">FlipSync</h1>
            <p className="text-xs text-gray-500 mt-0.5">Voice dataset extraction</p>
          </div>
          <button
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {!isLoading && !error && projects.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <h2 className="text-base font-semibold text-gray-900 mb-1">No projects yet</h2>
            <p className="text-sm text-gray-500 mb-6">Create your first project to start extracting voice datasets.</p>
            <button
              onClick={() => setShowModal(true)}
              className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors"
            >
