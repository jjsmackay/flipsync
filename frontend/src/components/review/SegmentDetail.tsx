      ...
      <div className={`flex gap-2 ${segment.status === 'auto_approved' ? '' : 'mt-auto'} pt-2 border-t border-gray-100`}>
        {segment.status === 'rejected' ? (
          ...
          <button
            ...
            className="flex-1 py-2 rounded text-sm font-medium bg-indigo-100 text-indigo-800 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-400"
          >
